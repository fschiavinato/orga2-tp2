...
max: dd vmax_f, vmax_f, vmax_f, vmax_f
...
.cargado:
    ...
    psrl xmm10, bs_byte ; xmm10 = |a05|r05|g05|b05|a04|r04|g04|b04|
    punpckhbw xmm11, xmm5 ; xmm11 = |a07|*|r07|*|g07|*|b07|*|a06|*|r06|*|g06|*|b06|*|
    psrl xmm11, bs_byte ; xmm10 = |a07|r07|g07|b07|a06|r06|g06|b06|
    ...
    punpckhbw xmm2, xmm9 ; xmm13 = |a47|*|r47|*|g47|*|b47|*|a46|*|r46|*|g46|*|b46|*|
    ...
    psrlld xmm10, bs_word ; xmm10 =  |p47+p37+p27+p17+p07|p46+p36+p26+p16+p06|p45+p35+p25+p15+p05|p44+p34+p24+p14+p04|
    ...
    pshufd xmm3, 00h ; xmm3 = |alpha|alpha|alpha|alpha|

    pmulld xmm0, xmm3 ; xmm0 = |alpha*sumargb25|alpha*sumargb24|alpha*sumargb23|alpha*sumargb22|
    movdqa xmm1, xmm0
    movdqa xmm2, xmm0

    ; xmm15 = |a25|r25|g25|b25|a24|r24|g24|b24|a23|r23|g23|b23|a22|r22|g22|b22|
    movdqa xmm3, xmm15
    ...
    padd xmm1, xmm4 ; xmm1 = |g25*max+alpha*sumargb25*g25|..|g22*max+alpha*sumargb22*g22|
    padd xmm2, xmm10  ; xmm2 = |r25*max+alpha*sumargb25*r25|..|r22*max+alpha*sumargb22*r22|
    ...
    pshufhw xmm1, xmm1, 11111010b ; xmm0 = |g25'|g25'|g24'|g24'|g25'|g24'|g23'|g22'|
    pshufhw xmm1, xmm1, 01010000b ; xmm0 = |g25'|g25'|g24'|g24'|g23'|g23'|g22'|g22'|
    ...
    psrlld xmm0, bs_word ; xmm0 = |0|g25'|b25'|0|g24'|b24'|0|g23'|b23'|0|g22'|b22'|   
    ...
    psrlld xmm2, bs_word ; xmm2 = |0|r25'|0|r24'|0|r23'|0|r22'|
    ...
    add xmm0, xmm15 ; xmm15 = |a25|r25'|g25'|b25'|a24|r24'|g24'|b24'|a23|r23'|g23'|b23'|a22|r22'|g22'|b22'|
    movdqu [rsi + 2*r9 + 2*s_pixel], xmm0
...
; Se encarga de mover los pixeles de memoria a los registros.
    ...
    paddub xmm15, xmm8 ; xmm15 = |a25|r25|g25|b25|a24|r24|g24|b24|a23|r23|g23|b23|a22|r22|g22|b22|
